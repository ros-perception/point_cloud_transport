...
#ifndef POINT_CLOUD_TRANSPORT__VISIBILITY_CONTROL_H_
#define POINT_CLOUD_TRANSPORT__VISIBILITY_CONTROL_H_
...
#endif  // POINT_CLOUD_TRANSPORT__VISIBILITY_CONTROL_H_
